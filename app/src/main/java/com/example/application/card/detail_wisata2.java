...
import com.example.application.wisata.wisatabudaya;
import com.example.application.wisata.wisataumum;

public class detail_wisata2 extends AppCompatActivity{
    ...
    public void backdetail (View v){
        Intent back = new Intent(detail_wisata2.this, wisatabudaya.class);
        startActivity(back);
    }
}